...
| Agent | 职责 | 功能 |
|-------|------|------|
| 太子 | 记忆分拣 | 判断内容价值，创建记忆旨意 |
| 中书省 | 记忆规划 | 设计分类方案，规划存储层级 |
| 门下省 | 记忆审核 | 评估重要性 (0-10分)，决定通过/封驳 |
| 尚书省 | 记忆调度 | 派发到对应部门处理 |
| 户部 | 存储管理 | 配额监控，容量管理 |
| 吏部 | 关系图谱 | 实体关联，索引维护 |
| 刑部 | 记忆审判 | 删除无用/错误记忆 |
...
```
agents_enhanced/
├── taizi_SOUL.md        # 太子 - 记忆分拣
├── zhongshu_SOUL.md    # 中书省 - 记忆规划
├── menxia_SOUL.md      # 门下省 - 记忆审核
├── shangshu_SOUL.md    # 尚书省 - 记忆调度
├── hubu_SOUL.md        # 户部 - 存储管理
├── libu_SOUL.md        # 吏部 - 关系图谱
├── xingbu_SOUL.md      # 刑部 - 记忆审判
├── gongbu_SOUL.md      # 工部 - 检索优化
└── libu_hr_SOUL.md    # 吏部HR - 记忆审计
```

### 使用方式

1. 部署 三省六部制 (edict)
2. Agent 自动加载增强后的 SOUL.md
3. 用户说"记住xxx"触发记忆流程
